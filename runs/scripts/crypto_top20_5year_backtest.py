"""
Cryptocurrency Top 20 5-Year Backtest Analysis (2020-2024)
Analyzes top 20 cryptocurrencies by 24h trading volume with Bollinger Band Squeeze strategy
"""
...
def run_yearly_backtest(year: int):
    ...
    config_path = f'runs/configs/examples/crypto_top20_{year}.yaml'
    ...
    try:
        ...
        print(f"\n{'='*70}")
        print(f"Cryptocurrency Top 20 Backtest: {year}")
        print(f"{'='*70}")
        print(f"Symbols: Top 20 by 24h volume")
...
def main():
    """Run 5-year cryptocurrency top 20 backtest analysis."""
    print("\n" + "="*70)
    print("CRYPTOCURRENCY TOP 20 5-YEAR BACKTEST ANALYSIS (2020-2024)")
    print("="*70)
    print("\nStrategy: Bollinger Band Squeeze + Volume + RSI")
    print("Universe: Top 20 by 24h trading volume")
    ...
    if results:
        print("\n\n" + "="*70)
        print("5-YEAR SUMMARY - TOP 20 CRYPTOCURRENCIES")
        print("="*70)
        ...
        # Compare with 5-coin and Top 100 strategies
        print("\n" + "="*70)
        print("COMPARISON: 5 COINS vs TOP 20 vs TOP 100")
        print("="*70)
        print(f"{'Metric':<30} {'5 Coins':<20} {'Top 20':<20} {'Top 100':<20}")
        print("-" * 70)
        print(f"{'Universe':<30} {'5 major':<20} {'20 high volume':<20} {'~70 tradeable':<20}")
        print(f"{'5-Year Avg Return':<30} {'+12.39%':<20} {f'{avg_return:.2f}%':<20} {'-7.65%':<20}")
        print(f"{'5-Year Compound':<30} {'+68.89%':<20} {f'{compound_return:.2f}%':<20} {'-7.65%':<20}")
        print(f"{'CAGR':<30} {'+11.05%':<20} {f'{cagr:.2f}%':<20} {'-1.58%':<20}")
        print(f"{'Total Trades (5yr)':<30} {'31':<20} {f'{total_trades}':<20} {'517':<20}")
        avg_win_rate = sum(r['win_rate_pct'] for r in results) / len(results)
        print(f"{'Avg Win Rate':<30} {'48.4%':<20} {f'{avg_win_rate:.2f}%':<20} {'21.4%':<20}")
        print("="*70)
