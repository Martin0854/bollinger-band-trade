...
class BuySignalResponse(BaseModel):
    ...
    reason: str
    indicators: dict
    affordable: bool  # Whether user can afford this stock
...
async def get_recommendations(
    ...
    # Scan for signals
    scanner = SignalScanner(confidence_threshold=confidence_threshold)
    ...
    for sig in signals:
        ...
        all_buy_signals.append(
            BuySignalResponse(
                ...
                stock_name=sig.stock_name,
                current_price=sig.current_price,
                confidence_score=int(sig.confidence_score),
                reason=sig.reason,
                indicators=sig.indicators,
