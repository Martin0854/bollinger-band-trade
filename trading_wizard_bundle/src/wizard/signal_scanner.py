...
class SignalScanner:
    ...
    def __init__(
        ...
        Args:
            confidence_threshold: Minimum confidence score for BUY signals
    ...
    def scan_for_sell_signals(
        ...
        for i, pos in enumerate(positions):
            ...
            # Check SELL conditions (based on technical signals, not fixed profit target)
            sell_reason = None
            ...
            # 2. Price below lower Bollinger Band (original strategy exit signal)
            ...
            if sell_reason:
                ...
                signals.append(
                    StockSignal(
                        ...
                        stock_name=stock_name,
                        signal_type="SELL",
                        confidence_score=100,  # SELL signals are high priority
