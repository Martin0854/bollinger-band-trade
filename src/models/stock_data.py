"""
StockData model for managing OHLCV data with indicators.
...
class StockData:
    """
    StockData wraps OHLCV data with computed indicators.
    ...
    def __post_init__(self):
        """Validate stock data."""
        # Validate stock_code format
        validate_stock_code(self.stock_code)

        # Validate OHLCV data integrity
        validate_ohlcv_dataframe(self.ohlcv, self.stock_code)
    ...
    def add_bollinger_bands(self, bands: pd.DataFrame) -> None:
        """
        Add computed Bollinger Bands to stock data.
    ...
    def to_dict(self) -> dict:
        """
        Convert StockData to dictionary representation.
